		...
		<section id="sidebar_section">
			<div className={`mini_sidebar collapsedd bg-dark h-100 ${showSidebar ? 'expanded' : null}`}>
				<div className="p-0 m-0">
					<Avatar name="سیامند شیرزاد" imagePath="/assets/images/avatar/user.jpg" />
					<SidebarItem targetPath="/dashbord"  icon="fas fa-tachometer-alt" title="داشبورد" />
					{/* <!-- =================================== --> */}
					...
					<SidebarItem targetPath="/manage-carts" icon="fas fa-shopping-basket" title="مدیریت سبد ها" />
