...
const EditCarts = () => {
	return (
		<>
			...
			<ModalsContainer id={'edit_cart_modal'} title={'جزئیات سبد خرید'} fullscreen={true}>
				{' '}
						...
						<div className="col-12 col-md-6 col-lg-8">
							<div className="input-group my-3 dir_ltr">
								...
								<span className="input-group-text text-end w_70 font_08 d-flex align-items-center text_truncate">
									...
									<i className="fas fa-circle mx-1" style={{ style: '#000' }}></i>
								</span>
							</div>
						</div>
						<div className="col-12 col-md-6 col-lg-8">
							<div className="input-group my-3 dir_ltr">
								...
								<span className="input-group-text text-end w_70 font_08 d-flex align-items-center text_truncate">
									...
									<i className="fas fa-circle mx-1" style={{ style: 'rgb(236, 16, 16)' }}></i>
								</span>
							</div>
						</div>
						<div className="col-6">
